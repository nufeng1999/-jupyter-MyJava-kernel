...
class JavaKernel(MyKernel):
    ...
    def _exec_javac_(self,source_filename,magics):
        ...
        if p.returncode != 0:  # Compilation failed
            ...
            self._log("Javac exited with code {}, the executable will not be executed".format(p.returncode),3)
    ...
    def do_create_codefile(self,magics,code, silent, store_history=True,
        ...
        with self.new_temp_file(suffix='.java') as source_file:
            source_file.write(code)
            source_file.flush()
